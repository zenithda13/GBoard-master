...
/**
 * Servlet implementation class AddExistingUserToTheGroup
 */
public class AddExistingUserToTheGroup extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddExistingUserToTheGroup() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String _user_login = request.getParameter("u_l");
        ...
        try {
        	...
        	if( (group_mnemonic == null || group_mnemonic.length() == 0) || (_user_login == null || _user_login.length() == 0) ) {
    		...
    		if(setPT2.next()) {
    			jsonResponse.put("notice", "<span style=\"font-weight: bold;\">"+userName+" ("+_user_login+")</span> is already a member of the <span style=\"font-weight: bold;\">"+groupName+"</span> group");
    			out.println(jsonResponse.toString());
    		...
    		if (!apdateFlag) {
    			jsonResponse.put("success", "<span style=\"font-weight: bold;\">"+userName+" ("+_user_login+")</span> successfully added to the <span style=\"font-weight: bold;\">"+groupName+"</span> group");    			
    			...
    			jsonResponse.put("error", "ERROR! SQL exception occurred while adding <span style=\"font-weight: bold;\">"+userName+" ("+_user_login+")</span> to the <span style=\"font-weight: bold;\">"+groupName+"</span> group");
